...
func (c *Context) NewParent(parent Interface) Parent {
	return Parent{
		Context:   c,
		Interface: parent,
	}
...
func (p *Parent) Parents() []Interface {
	if p.Interface == nil {
		return []Interface{}
	}
...
func (p *Parent) Get() (zbuf.Batch, error) {
	return p.Interface.Pull()
}

func (p *Parent) Link(parent Interface) Parent {
	return Parent{
		Context:   p.Context,
		Interface: parent,
	}
