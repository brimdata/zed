...
| [`string`](https://docs.zeek.org/en/current/script-reference/types.html#type-string)     | [`bstring` or `string`](../docs/data-model/zson.md#33-primitive-values) | See [`string` details](#string) |
