...
<html>
  ...
  <body style="padding:10px">
    ...
    <p>If your goal is to perform command line operations against this Zed lake, use the <a href="https://github.com/brimdata/zed/tree/main/cmd/zed">Zed</a> client.</p>
  </body>
</html>`
