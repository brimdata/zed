...
* For the permutations of `ndjson` input and `zeek` output, the approach
described in [shaping Zeek NDJSON]
https://github.com/brimdata/zed/blob/main/zeek/Shaping-Zeek-NDJSON.md) was
followed as the input data was being read. In addition to conforming to the
