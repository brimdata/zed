...
func (a Analyzer) ConvertValue(zctx *Context, val ast.Value) (Value, error) {
	return a.convertValue(zctx, val, nil)
}

func (a Analyzer) convertValue(zctx *Context, val ast.Value, parent zng.Type) (Value, error) {
	switch val := val.(type) {
...
func (a Analyzer) convertAny(zctx *Context, val ast.Any, cast zng.Type) (Value, error) {
...
func (a Analyzer) convertPrimitive(zctx *Context, val *ast.Primitive, cast zng.Type) (Value, error) {
...
func (a Analyzer) convertRecord(zctx *Context, val *ast.Record, cast zng.Type) (Value, error) {
	var fields []Value
	var err error
	if cast != nil {
...
func (a Analyzer) convertFields(zctx *Context, in []ast.Field, cols []zng.Column) ([]Value, error) {
...
func lookupRecordType(zctx *Context, fields []ast.Field, vals []Value) (*zng.TypeRecord, error) {
...
func (a Analyzer) convertArray(zctx *Context, array *ast.Array, cast zng.Type) (Value, error) {
...
func (a Analyzer) convertEnum(zctx *Context, val *ast.Enum, cast zng.Type) (Value, error) {
	if cast == nil {
...
func (a Analyzer) convertType(zctx *Context, typ ast.Type) (zng.Type, error) {
	switch t := typ.(type) {
...
func (a Analyzer) convertTypeRecord(zctx *Context, typ *ast.TypeRecord) (*zng.TypeRecord, error) {
	fields := typ.Fields
	columns := make([]zng.Column, 0, len(fields))
...
func (a Analyzer) convertTypeMap(zctx *Context, tmap *ast.TypeMap) (*zng.TypeMap, error) {
...
func (a Analyzer) convertTypeUnion(zctx *Context, union *ast.TypeUnion) (*zng.TypeUnion, error) {
	var types []zng.Type
...
func (a Analyzer) convertTypeEnum(zctx *Context, enum *ast.TypeEnum) (*zng.TypeEnum, error) {
	n := len(enum.Elements)
	if n == 0 {
