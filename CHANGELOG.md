...
* Make the [`fuse`](https://github.com/brimdata/zed/tree/main/docs/language/operators#fuse) operator work on nested records (#2052)
...
* Extend [`join`](https://github.com/brimdata/zed/tree/main/docs/language/operators#join) to support `inner` (now the default), `left`, and `right` variations (#2210)
...
* Add the [Zed lake design](https://github.com/brimdata/zed/blob/main/docs/lake/README.md) document (#2500, #2569, #2595, #2781, #2940)
...
* Add support for Git-style Zed lakes (#2548, #2556, #2562, #2563, #2564, #2566, #2571, #2577, #2580, #2616, #2613, #2738, #2763, #2806, #2808, #2811, #2816, #2860, #2861, #2931, #2944)
...
* Field assignments in [`join`](https://github.com/brimdata/zed/blob/main/docs/language/operators/README.md#join) now behave like [`cut`](https://github.com/brimdata/zed/blob/main/docs/language/operators/README.md#cut) instead of [`pick`](https://github.com/brimdata/zed/blob/main/docs/language/operators/README.md#pick) (#2868)
* Add more background/context to Zed top-level language [README](https://github.com/brimdata/zed/blob/main/docs/language/README.md) (#2866 #2878, #2901)
* Unify `from`, `split`, and `switch` syntax, as shown [here](https://github.com/brimdata/zed/tree/main/docs/language#directed-acyclic-flow-graphs) (#2871, #2896)
...
* Introduce alternate `switch()` syntax (#2888)
