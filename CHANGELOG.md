...
* Add the `taste` operator (#2200, #2211)
* Make `.`/`this` an implicit argument to `shape()` (#2199)
* Begin deprecating current TZNG format in favor of ZSON (#2208, #2312, #2333, #2338, #2337, #2339, #2340, #2355, #2367, #2377, #2387, #2388, #2389, #2395, #2477, #2485)
...
* Add a reference [shaper for Zeek data](https://github.com/brimdata/zed/blob/main/zeek/Shaping-Zeek-NDJSON.md) (#2300, #2368, #2448, #2489)
...
* Create the `zed` command with sub-commands like `query` and `api`, but shortcut commands (e.g., `zq`, `zapi`) also remain (#2450, #2465, #2466, #2463)
...
* Add casting to the `net` data type (#2493)
