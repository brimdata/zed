...
* Improve handling of errors during [shaping](docs/language/overview/shaping.md) (#4067, #4069)
...
* Support `...` spread operator in [array expressions](docs/language/overview/expressions.md#array-expressions) and [set expressions](docs/language/overview/expressions.md#set-expressions) (#3910)
...
* Add [`over` expressions](docs/language/overview/lateral-subqueries.md#lateral-expressions) (#3797)
