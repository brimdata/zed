...
* Begin deprecating current TZNG format in favor of ZSON (#2208, #2312, #2333, #2338
...
* Add canonical Zed and the `summarize` operator (#2217)
...
* Add a reference [shaper for Zeek data](https://github.com/brimdata/zed/blob/main/zeek/Shaping-Zeek-NDJSON.md) (#2300)
...
* Use a Zed shaper insdtead 
* Apply a Zed shaper when reading Suricata EVE data, instead of legacy JSON typing (#2298)
