...
* Add canonical Zed and the `summarize` operator (#2217, #2378, #2408)
...
* Add functions `missing()`, `has()`, and `nameof()` (#2393)
...
* The role previously performed by `zqd` is now handled by `zed lake serve` (#2629)
