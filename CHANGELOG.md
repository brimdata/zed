...
* zq: Fix an issue with [`rename`](https://github.com/brimdata/zed/tree/main/zql/docs/processors#rename) where a subsequent `count()` would return no results (#2046)
...
* zq: Add support in [`put`](https://github.com/brimdata/zed/tree/main/zql/docs/processors#put) for assigning to `.` and to nested fields (#2018)
...
* zson: Update [Zeek Interoperability doc](https://github.com/brimdata/zed/blob/main/zng/docs/zeek-compat.md) to include current ZSON syntax (#1956)
* zq: Ensure the output from the [`fuse`](https://github.com/brimdata/zed/tree/main/zql/docs/processors#fuse) processor is deterministic (#1958)
...
* zq/zqd: Invoke [`fuse`](https://github.com/brimdata/zed/tree/main/zql/docs/processors#fuse) automatically when CSV output is requested (#1908)
* zq: Fix an issue where [`fuse`](https://github.com/brimdata/zed/tree/main/zql/docs/processors#fuse) was not preserving record order (#1909)
...
* zson: Add a [draft specification](https://github.com/brimdata/zed/blob/main/zng/docs/zson.md) of the new ZSON format (#1715, #1735, #1741, #1765)
...
* zql: Add a new [`drop`](https://github.com/brimdata/zed/tree/main/zql/docs/processors#drop) processor, which replaces `cut -c` (#1773)
* zql: Add a new [`pick`](https://github.com/brimdata/zed/tree/main/zql/docs/processors#pick) processor, which acts like a stricter [`cut`](https://github.com/brimdata/zed/tree/main/zql/docs/processors#cut) (#1773, #1788)
...
* zql: Add support for [aggregation-less group by](https://github.com/brimdata/zed/tree/main/zql/docs/grouping#example-1-1) (#1615, #1623)
...
* zql: Add a [docs example](https://github.com/brimdata/zed/tree/main/zql/docs/grouping#example-4) showing `by` grouping with non-present fields (#1703)

## v0.23.0
* zql: Add `week` as a unit for [time grouping with `every`](https://github.com/brimdata/zed/tree/main/zql/docs/grouping#time-grouping---every) (#1374)
...
* zq: Add [`zst` format](https://github.com/brimdata/zed/blob/main/zst/README.md) to `-i` and `-f` command-line help (#1384)
...
* zq: Allow the [`fuse` processor](https://github.com/brimdata/zed/tree/main/zql/docs/processors#fuse) to spill-to-disk to avoid memory limitations (#1355, #1402)
...
* zql: Improve ZQL docs for [aggregate functions](https://github.com/brimdata/zed/blob/main/zql/docs/aggregate-functions/README.md) and [grouping](https://github.com/brimdata/zed/blob/main/zql/docs/grouping/README.md) (#1385)
...
* zq: Update the [ZNG over JSON (ZJSON)](https://github.com/brimdata/zed/blob/main/zng/docs/zng-over-json.md) spec and implementation (#1299)
...
* zql: Add [`where` filtering](https://github.com/brimdata/zed/tree/main/zql/docs/aggregate-functions#where-filtering) for use with aggregate functions (#1490, #1481, #1533)
* zql: Add [`union()`](https://github.com/brimdata/zed/tree/main/zql/docs/aggregate-functions#union) aggregate function (#1493, #1534)
* zql: Add [`collect()`](https://github.com/brimdata/zed/tree/main/zql/docs/aggregate-functions#collect) aggregate function (#1496, #1534)
* zql: Add [`and()`](https://github.com/brimdata/zed/tree/main/zql/docs/aggregate-functions#and) and [`or()`](https://github.com/brimdata/zed/tree/main/zql/docs/aggregate-functions#or) aggregate functions (#1497, #1534)
...
## v0.22.0
* zq: Change the implementation of the `union` type to conform with the [ZNG spec](https://github.com/brimdata/zed/blob/main/zng/docs/spec.md#3114-union-typedef) (#1245)
...
* zql: Add the [`fuse` processor](https://github.com/brimdata/zed/tree/main/zql/docs/processors#fuse) for unifying records under a single schema (#1310, #1319, #1324)
* zql: Fix broken links in documentation (#1321, #1339)
* zst: Introduce the [ZST format](https://github.com/brimdata/zed/blob/main/zst/README.md) for columnar data based on ZNG (#1268, #1338)
* pcap: Fix an issue where certain pcapng files could fail import with a `bad option length` error (#1341)
* zql: [Document the `**` operator](https://github.com/brimdata/zed/tree/main/zql/docs/search-syntax#wildcard-field-names) for type-sepcific searches that look within nested records (#1337)
...
* zng: Fix the tag value examples in the [ZNG spec](https://github.com/brimdata/zed/blob/main/zng/docs/spec.md) (#1230)
...
## v0.19.0
* zq: ZNG output is now LZ4-compressed by default (#1050, #1064, #1063, [ZNG spec](https://github.com/brimdata/zed/blob/main/zng/docs/spec.md#313-compressed-value-message-block))
...
* zql: Add a new [`rename` processor](https://github.com/brimdata/zed/tree/main/zql/docs/processors#rename) to rename fields in a record (#998, #1038)
...
* zng: Readability improvements in the [ZNG specification](https://github.com/brimdata/zed/blob/main/zng/docs/spec.md) (#935)
...
## v0.16.0
* zng: Readability improvements in the [ZNG specification](https://github.com/brimdata/zed/blob/main/zng/docs/spec.md) (#897, #910, #917)
...
* zng: Revise [Zeek compatibility](https://github.com/brimdata/zed/blob/main/zng/docs/zeek-compat.md) doc (#919)
* zql: Clarify [`cut` processor documentation](https://github.com/brimdata/zed/tree/main/zql/docs/processors#cut) (#924)
...
* zql: Clean up the [ZQL docs](https://github.com/brimdata/zed/tree/main/zql/docs) (#884)
