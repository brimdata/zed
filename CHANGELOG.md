...
* Add support for reading comma-separated value (CSV) files (#2317)
...
* Code/repo reorganization for phasing out "ZQL" in favor of "Zed language" (#2416, #2431, #2455)
...
* Add the [Zed lake design](https://github.com/brimdata/zed/blob/main/docs/lake/design.md) document (#2500, #2569, #2595)
...
* Add support for Git-style Zed lakes (#2548, #2556, #2562, #2563, #2564, #2566, #2571, #2577, #2580, #2616, #2613,
...
* Improve the error message shown when no Zed lake root is specified (#2701)
...
* Fix an issue where a shaper craeted a corrupt time value from an invalid timestamp rather than rejecting it (#2705)
* Simplify keyword search by requiring `:=` for assignment, `==` for comparison, and using `matches for regex match and glob match (#2692)
