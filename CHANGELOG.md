...
* [Python client](python/super): rework `zed.Client.query_raw()` to handle any format (#3911)
...
* [Python client](python/super): Improve error messages (#3279)
* [Python client](python/super): Fix Zed `bytes` decoding (#3278)
...
* [Python client](python/super): Add authentication (#3270)
* [Python client](python/super): Handle query errors  (#3269)
