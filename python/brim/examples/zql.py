...
parser = argparse.ArgumentParser(description='Evaluate zql expression against a named file (or stdin by specifying "-")')
...
parser.add_argument('args', nargs='*', help='<zql>  [ <input-file> | - ]  [ <output-file> | - ]')
