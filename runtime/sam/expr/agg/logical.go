...
func (a *And) Result(*zed.Arena) zed.Value {
	if a.val == nil {
		return zed.NullBool
	}
...
func (a *And) ResultAsPartial(arena *zed.Arena) zed.Value {
	return a.Result(arena)
}
...
func (o *Or) Result(*zed.Arena) zed.Value {
	if o.val == nil {
		return zed.NullBool
	}
...
func (o *Or) ResultAsPartial(arena *zed.Arena) zed.Value {
	return o.Result(arena)
}
