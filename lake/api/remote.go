...
type RemoteSession struct {
	...
	//pools map[ksuid.KSUID]*lake.Pool //XXX
}
...
func (r *RemoteSession) LookupPoolByName(ctx context.Context, name string) (*lake.PoolConfig, error) {
	res, err := r.conn.ScanPools(ctx)
	if err != nil {
		return nil, nil
	}
...
func (r *RemoteSession) LookupPool(ctx context.Context, id ksuid.KSUID) (*lake.PoolConfig, error) {
...
func (r *RemoteSession) LookupIndexRules(context.Context, string) ([]index.Rule, error) {
	return nil, errors.New("unsupported")
}
...
func (r *RemoteSession) ScanIndexRules(ctx context.Context, w zio.Writer, ids []ksuid.KSUID) error {
	return errors.New("unsupported")
}

func (r *RemoteSession) Query(ctx context.Context, d driver.Driver, src string, filenames ...string) (zbuf.ScannerStats, error) {
...
func (r *RemoteSession) ScanSegments(ctx context.Context, poolID ksuid.KSUID, w zio.Writer, at ksuid.KSUID, partitions bool, span extent.Span) (err error) {
	// XXX ScanSegments should just be a query endpoint that says to
	// stream the particular zng log (like the rest of them)
