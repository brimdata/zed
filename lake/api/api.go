...
type Interface interface {
	...
	CreateTag(ctx context.Context, pool ksuid.KSUID, name string, parent ksuid.KSUID) error
	RemoveTag(ctx context.Context, pool ksuid.KSUID, tagName string) error
