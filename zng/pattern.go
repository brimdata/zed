...
func EncodePattern(v *regexp.Regexp) zcode.Bytes {
	return []byte(v.String())
}

func DecodePattern(zv zcode.Bytes) (*regexp.Regexp, error) {
	if zv == nil {
		return nil, ErrUnset
	}
...
func (t *TypeOfPattern) Parse(in []byte) (zcode.Bytes, error) {
...
func (t *TypeOfPattern) New(zv zcode.Bytes) (Value, error) {
