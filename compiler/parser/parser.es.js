...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c193 = function() { return {"kind":"This"} },
      ...
      peg$c425 = "ip",
      peg$c426 = peg$literalExpectation("ip", false),
      peg$c427 = "net",
      peg$c428 = peg$literalExpectation("net", false),
      peg$c429 = "error",
      peg$c430 = peg$literalExpectation("error", false),
      peg$c431 = function() {
                return {"kind": "TypePrimitive", "name": text()}
              },
      peg$c432 = function(name, typ) {
            return {"name": name, "type": typ}
          },
      peg$c433 = "and",
      peg$c434 = peg$literalExpectation("and", true),
      peg$c435 = function() { return "and" },
      peg$c436 = "or",
      peg$c437 = peg$literalExpectation("or", true),
      peg$c438 = function() { return "or" },
      peg$c441 = peg$literalExpectation("not", true),
      peg$c442 = function() { return "not" },
      peg$c443 = "by",
      peg$c444 = peg$literalExpectation("by", true),
      peg$c445 = function() { return "by" },
      peg$c446 = /^[A-Za-z_$]/,
      peg$c447 = peg$classExpectation([["A", "Z"], ["a", "z"], "_", "$"], false, false),
      peg$c448 = /^[0-9]/,
      peg$c449 = peg$classExpectation([["0", "9"]], false, false),
      peg$c450 = function(id) { return {"kind": "ID", "name": id} },
      peg$c451 = "$",
      peg$c452 = peg$literalExpectation("$", false),
      peg$c453 = "T",
      peg$c454 = peg$literalExpectation("T", false),
      peg$c455 = function() {
            return {"kind": "Primitive", "type": "time", "text": text()}
          },
      peg$c456 = "Z",
      peg$c457 = peg$literalExpectation("Z", false),
      peg$c458 = function() {
            return {"kind": "Primitive", "type": "duration", "text": text()}
          },
      peg$c459 = "ns",
      peg$c460 = peg$literalExpectation("ns", true),
      peg$c461 = "us",
      peg$c462 = peg$literalExpectation("us", true),
      peg$c463 = "ms",
      peg$c464 = peg$literalExpectation("ms", true),
      peg$c465 = "s",
      peg$c466 = peg$literalExpectation("s", true),
      peg$c467 = "m",
      peg$c468 = peg$literalExpectation("m", true),
      peg$c469 = "h",
      peg$c470 = peg$literalExpectation("h", true),
      peg$c471 = "d",
      peg$c472 = peg$literalExpectation("d", true),
      peg$c473 = "w",
      peg$c474 = peg$literalExpectation("w", true),
      peg$c475 = "y",
      peg$c476 = peg$literalExpectation("y", true),
      peg$c477 = function(a, b) {
            return joinChars(a) + b
          },
      peg$c478 = "::",
      peg$c479 = peg$literalExpectation("::", false),
      peg$c480 = function(a, b, d, e) {
      ...
      peg$c488 = function(s) { return parseInt(s) },
      peg$c489 = function() {
            return text()
          },
      peg$c490 = "e",
      peg$c491 = peg$literalExpectation("e", true),
      peg$c492 = /^[+\-]/,
      peg$c493 = peg$classExpectation(["+", "-"], false, false),
      peg$c494 = /^[0-9a-fA-F]/,
      peg$c495 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"]], false, false),
      peg$c496 = function(v) { return joinChars(v) },
      peg$c497 = peg$anyExpectation(),
      peg$c498 = function(head, tail) { return head + joinChars(tail) },
      peg$c499 = /^[a-zA-Z_.:\/%#@~]/,
      ...
      peg$c505 = "b",
      peg$c506 = peg$literalExpectation("b", false),
      peg$c507 = function() { return "\b" },
      peg$c508 = "f",
      peg$c509 = peg$literalExpectation("f", false),
      peg$c510 = function() { return "\f" },
      peg$c511 = "n",
      peg$c512 = peg$literalExpectation("n", false),
      peg$c513 = function() { return "\n" },
      peg$c514 = "r",
      peg$c515 = peg$literalExpectation("r", false),
      peg$c516 = function() { return "\r" },
      peg$c517 = "t",
      peg$c518 = peg$literalExpectation("t", false),
      peg$c519 = function() { return "\t" },
      peg$c520 = "v",
      peg$c521 = peg$literalExpectation("v", false),
      peg$c522 = function() { return "\v" },
      peg$c523 = function() { return "*" },
      peg$c524 = "u",
      peg$c525 = peg$literalExpectation("u", false),
      peg$c526 = function(chars) {
            return makeUnicodeChar(chars)
          },
      peg$c527 = /^[^\/\\]/,
      peg$c528 = peg$classExpectation(["/", "\\"], true, false),
      peg$c529 = /^[\0-\x1F\\]/,
      peg$c530 = peg$classExpectation([["\0", "\x1F"], "\\"], false, false),
      peg$c531 = peg$otherExpectation("whitespace"),
      peg$c532 = "\t",
      peg$c533 = peg$literalExpectation("\t", false),
      peg$c534 = "\x0B",
      peg$c535 = peg$literalExpectation("\x0B", false),
      peg$c536 = "\f",
      peg$c537 = peg$literalExpectation("\f", false),
      peg$c538 = " ",
      peg$c539 = peg$literalExpectation(" ", false),
      peg$c540 = "\xA0",
      peg$c541 = peg$literalExpectation("\xA0", false),
      peg$c542 = "\uFEFF",
      peg$c543 = peg$literalExpectation("\uFEFF", false),
      peg$c544 = /^[\n\r\u2028\u2029]/,
      peg$c545 = peg$classExpectation(["\n", "\r", "\u2028", "\u2029"], false, false),
      peg$c546 = peg$otherExpectation("comment"),
      peg$c551 = "//",
