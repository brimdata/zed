...
2
```
Note here that the query `1+1` [implies](../language/overview/dataflow-model.md#implied-operators)
`yield 1+1`.
...
[its shortcuts](../language/overview/dataflow-model.md#implied-operators).
...
[first-class Zed errors](../language/overview/data-types.md#first-class-errors)
