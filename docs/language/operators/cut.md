...
form of one or more [field assignments](../overview/dataflow-model.md#field-assignments),
...
[record literal](../overview/expressions.md#record-expressions) having the form:
```
