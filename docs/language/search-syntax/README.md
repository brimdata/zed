...
#### Output:
```mdtest-output head
{_path:"conn",ts:2018-03-24T17:15:21.255387Z,uid:"C8Tful1TvM3Zf5x8fl"(bstring),id:{orig_h:10.164.94.120,orig_p:39681(port=(uint16)),resp_h:10.47.3.155,resp_p:3389(port)},proto:"tcp"(=zenum),service:null(bstring),duration:4.266ms,orig_bytes:97(uint64),resp_bytes:19(uint64),conn_state:"RSTR"(bstring),local_orig:null(bool),local_resp:null(bool),missed_bytes:0(uint64),history:"ShADTdtr"(bstring),orig_pkts:10(uint64),orig_ip_bytes:730(uint64),resp_pkts:6(uint64),resp_ip_bytes:342(uint64),tunnel_parents:null(|[bstring]|)}
{_path:"conn",ts:2018-03-24T17:15:21.411148Z,uid:"CXWfTK3LRdiuQxBbM6"(bstring),id:{orig_h:10.47.25.80,orig_p:50817(port=(uint16)),resp_h:10.128.0.218,resp_p:23189(port)},proto:"tcp"(=zenum),service:null(bstring),duration:486us,orig_bytes:0(uint64),resp_bytes:0(uint64),conn_state:"REJ"(bstring),local_orig:null(bool),local_resp:null(bool),missed_bytes:0(uint64),history:"Sr"(bstring),orig_pkts:2(uint64),orig_ip_bytes:104(uint64),resp_pkts:2(uint64),resp_ip_bytes:80(uint64),tunnel_parents:null(|[bstring]|)}
{_path:"conn",ts:2018-03-24T17:15:21.926018Z,uid:"CM59GGQhNEoKONb5i"(bstring),id:{orig_h:10.47.25.80,orig_p:50817(port=(uint16)),resp_h:10.128.0.218,resp_p:23189(port)},proto:"tcp"(=zenum),service:null(bstring),duration:538us,orig_bytes:0(uint64),resp_bytes:0(uint64),conn_state:"REJ"(bstring),local_orig:null(bool),local_resp:null(bool),missed_bytes:0(uint64),history:"Sr"(bstring),orig_pkts:2(uint64),orig_ip_bytes:104(uint64),resp_pkts:2(uint64),resp_ip_bytes:80(uint64),tunnel_parents:null(|[bstring]|)}
{_path:"conn",ts:2018-03-24T17:15:22.690601Z,uid:"CuKFds250kxFgkhh8f"(bstring),id:{orig_h:10.47.25.80,orig_p:50813(port=(uint16)),resp_h:10.128.0.218,resp_p:27765(port)},proto:"tcp"(=zenum),service:null(bstring),duration:546us,orig_bytes:0(uint64),resp_bytes:0(uint64),conn_state:"REJ"(bstring),local_orig:null(bool),local_resp:null(bool),missed_bytes:0(uint64),history:"Sr"(bstring),orig_pkts:2(uint64),orig_ip_bytes:104(uint64),resp_pkts:2(uint64),resp_ip_bytes:80(uint64),tunnel_parents:null(|[bstring]|)}
...
```
...
{server_tree_name:"factory.oompa.loompa"(bstring)}
{server_tree_name:"jerry.land"(bstring)}
...
```
...
1. To match successfully, the value must be comparable to the data type
   ...
   #### Output:
   ```mdtest-output head
   {host:"0988253c66242502070643933dd49e88.clo.footprintdns.com"(bstring),count:1(uint64)}
   {host:"10.47.21.1"(bstring),count:1(uint64)}
   {host:"10.47.21.80/.."(bstring),count:1(uint64)}
   ...
   ```
