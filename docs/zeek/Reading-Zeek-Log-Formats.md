...
equivalent [rich types in Zed](../formats/zson.md#33-primitive-values).
...
[aggregations with time-based grouping](../language/grouping.md#time-grouping---every)
or [CIDR matches](../language/search-syntax.md#example-14)
